        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter items-center">
          <div className="lg:col-span-6 flex flex-col justify-center z-10">
            <Ed
              ...
              className="text-[48px] sm:text-[64px] lg:text-[80px] font-display-lg text-primary text-balance mb-4 font-bold leading-[1.05]"
            />
            <Ed
              as="h2"
              p="home.hero.subhead"
              className="text-[28px] lg:text-[40px] font-headline-md text-primary text-balance mb-4 leading-[1.2]"
            />
            <Link
            ...
            >
              <Ed p="home.hero.inlineLink.label" />
            </Link>
            ...
            <div className="flex flex-wrap items-center gap-6 mt-4">
              ...
              >
                <Ed p="home.hero.ctaPrimary.label" />
              ...
              >
                <Ed p="home.hero.ctaSecondary.label" />
              </Link>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 lg:col-start-8 relative mt-stack-gap lg:mt-0">
            <div className="relative w-full aspect-[4/5] max-h-[58vh] rounded-lg overflow-hidden bg-surface-container-high">
              ...
              />
              <Ed
                p="home.hero.badgeLocation"
                className="absolute bottom-4 left-4 font-label-mono text-label-mono text-primary uppercase tracking-widest bg-white px-4 py-2 rounded-full shadow-md z-10"
              />
            </div>
          </div>
        </div>
